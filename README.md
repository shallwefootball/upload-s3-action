...
| `source_dir`            | (Required) The local directory you wish to upload to S3. The directory will replace to key generated by [shortid](https://github.com/dylang/shortid) in S3 |
