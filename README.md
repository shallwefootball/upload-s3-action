...
| `force_path_style`      | (Optional) Whether to use path style "https://example.net/{bucket}/", otherwise "https://{bucket}.example.net/". [More info here.](https://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/S3.html) |
